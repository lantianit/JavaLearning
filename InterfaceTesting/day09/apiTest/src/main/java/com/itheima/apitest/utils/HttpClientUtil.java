...
public class HttpClientUtil {
     ...
     * @return 统一处理结果
     */
    public static ResponseData postForm(String url, Map<String, String> queryParam, Map<String, Object> formParam)
            throws Exception {
        // 构建URL
        String newUrl = buildUrl(url, queryParam);
        ...
        if (formParam != null) {
            ...
            for (String key : formParam.keySet()) {
                params.add(new BasicNameValuePair(key, formParam.get(key).toString()));
            }
